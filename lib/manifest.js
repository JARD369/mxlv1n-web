...
(function () {
  ...
  window.__BRAND__ = {
    ...
    instagram: "https://www.instagram.com/mxlv1n1/",
    instagramHandle: "@mxlv1n1",
    ...
    links: {
      ...
      youtube: "",
      youtubeChannel: "https://www.youtube.com/@pablomalvin"
    },

    /* Featured release: hero button + a highlighted section right below the
       hero. Leave youtubeId empty to hide both. */
    newRelease: {
      title: "Vos y Yo",
      thumbnail: "assets/img/new-release.jpg",
      youtubeId: "BUZbryScHiY",
      youtubeTitle: "MALVIN - Vos y Yo (Video Oficial)",
      spotifyUrl: "https://open.spotify.com/track/3IIso6HrGiwdz56pFjHbRs"
    },
    ...
    i18n: {
      es: {
        ...
        releaseKicker: "Nuevo lanzamiento",
        releaseListen: "Escuchar en Spotify",
        scrollCue: "Desliza",
        ...
        galleryAlt7: "Pablo Malvin con traje blanco, cantando con micrófono vintage",
        galleryAlt8: "Silueta de Pablo Malvin tocando la guitarra",
        galleryAlt9: "Pablo Malvin tocando en vivo, luz cálida",
        galleryAlt10: "Retrato de Pablo Malvin con campera de cuero",
        galleryAlt11: "Pablo Malvin tocando la guitarra en vivo, luces rojas",
        galleryAlt12: "Pablo Malvin en sesión de fotos, publicada en Fantastics",
        galleryExpand: "Ampliar foto",
      ...
      en: {
        ...
        releaseKicker: "New release",
        releaseListen: "Listen on Spotify",
        scrollCue: "Scroll",
        ...
        galleryAlt7: "Pablo Malvin in a white suit, singing into a vintage microphone",
        galleryAlt8: "Silhouette of Pablo Malvin playing guitar",
        galleryAlt9: "Pablo Malvin performing live, warm lighting",
        galleryAlt10: "Portrait of Pablo Malvin wearing a leather jacket",
        galleryAlt11: "Pablo Malvin playing guitar live, red stage lights",
        galleryAlt12: "Pablo Malvin photo shoot, featured in Fantastics",
